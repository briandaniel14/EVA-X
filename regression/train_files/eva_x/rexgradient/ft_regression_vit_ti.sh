...
CKPT_DIR='/tmp/eva_x_checkpoints/eva_x_tiny_patch16_merged520k_mim.pt'
SAVE_DIR='./output/rexgradient/vit_ti_eva_x_regression'
VAL_LIST='../regression/datasets/data_splits/rexgradient/age_labels_valid.txt'
NUM_GPUS=1
NUM_CPUS=4
